import { Activity, Cable, Settings, Wand2 } from "lucide-react";
        ...
        <div className="mx-auto flex max-w-[1560px] flex-wrap items-center gap-2 px-3 py-3 sm:px-4">
          <div className="mr-auto flex min-w-0 items-center gap-3">
            ...
            <div className="min-w-0">
              <div className="truncate text-sm font-black text-white sm:text-base">Parish OBS Control</div>
              <div className="hidden text-xs font-semibold text-slate-500 sm:block">Transition manager workspace</div>
            </div>
          </div>
